...
/**
 * @brief Initialize the I2C by enabling the module, setting the address, setting the correct frequency, and enabling the interrupt to our i2c_simple_isr
 * 
...
/**
 * @brief This ISR allows for a fully asynchronous interface between controller and peripheral Transactions are able to begin immediately after a transaction ends
*/
