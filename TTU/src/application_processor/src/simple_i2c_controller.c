...
/******************************** FUNCTION PROTOTYPES ********************************/
/**
 * @brief Utilize the built-in I2C interrupt handler to allow for the use of MXC_I2C_Master_Transaction() function calls
 */
static void I2C_Handler(void) { MXC_I2C_AsyncHandler(I2C_INTERFACE); }

/******************************** FUNCTION DEFINITIONS ********************************/
/**
 * @brief Initialize the I2C by enabling the module, setting the correct frequency, and enabling the interrupt to our I2C_Handler
*/
...
/**
 * @brief Read the RECEIVE_DONE for an I2C peripheral and return the value 
 * 
...
/**
 * @brief Read the RECEIVE_LEN for an I2C peripheral and return the value 
 * 
 * @param addr: i2c_addr_t, address of I2C device
 * 
...
/**
 * @brief Read the TRANSMIT_DONE for an I2C peripheral and return the value 
 * 
 * @param addr: i2c_addr_t, address of I2C device
 * 
...
/**
 * @brief Read the TRANSMIT_LEN for an I2C peripheral and return the value 
 * 
 * @param addr: i2c_addr_t, address of I2C device
 * 
...
/**
 * @brief Write the RECEIVE_DONE reg for an I2C peripheral to the specified value 
 * 
 * @param addr: i2c_addr_t, address of I2C device
...
/**
 * @brief Write the RECEIVE_LEN reg for an I2C peripheral to the specified value
 * 
 * @param addr: i2c_addr_t, address of I2C device
...
/**
 * @brief Write the TRANSMIT_DONE reg for an I2C peripheral to the specified value
 * 
 * @param addr: i2c_addr_t, address of I2C device
...
/**
 * @brief Write the TRANSMIT_LEN reg for an I2C peripheral to the specified value
 * 
 * @param addr: i2c_addr_t, address of I2C device
...
/**
 * @brief Read any register larger than 1B in size. Can be used to read the PARAMS or RESULT register
 * 
 * @param addr: i2c_addr_t, address of I2C device
...
/**
 * @brief Write any register larger than 1B in size. Can be used to write the PARAMS or RESULT register
 * 
 * @param addr: i2c_addr_t, address of I2C device
...
int i2c_simple_write_data_generic(i2c_addr_t addr, ECTF_I2C_REGS reg, uint8_t len, uint8_t* buf) {
    ...
    if (len > 255 || sizeof(buf) > 255) {
        printf("i2c write prevented due to buffer overflow\n");
        return -1;
    }
...
/**
 * @brief Read any register that is 1B in size
 * 
 * @param addr: i2c_addr_t, address of I2C device
...
/**
 * @brief Write any register that is 1B in size
 * 
 * @param addr: i2c_addr_t, address of I2C device
 * @param reg: ECTF_I2C_REGS, register to write to
