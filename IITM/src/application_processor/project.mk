...
custom_all: ectf_params_encrypt add_nop_slides all remove_nop_slides

ectf_params_encrypt:
	python3 ./scripts/encrypt_pin.py ./inc/ectf_params.h ./inc/ectf_params_encrypted.h

add_nop_slides:
	python3 ../scripts/nop_slide.py ../custom_lib add
	python3 ../scripts/nop_slide.py ../application_processor add
remove_nop_slides:
	python3 ../scripts/nop_slide.py ../custom_lib remove
	python3 ../scripts/nop_slide.py ../application_processor remove