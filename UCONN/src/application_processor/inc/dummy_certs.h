 ...
 * @brief Dummy Server Test Certificates for TLS 1.3,
 * @date 2024
 * 
*/
...
#define SERV_CERT server_cert_der_1024

#define SERV_PRIV_KEY server_key_der_1024

#define CA_CERT_LEN sizeof_ca_cert_der_1024

#define SERV_CERT_LEN sizeof_server_cert_der_1024

#define SERV_PRIV_KEY_LEN sizeof_server_key_der_1024
